...
/*   Updated: 2025/10/13 19:43:20 by thmaitre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	load_texture(data, data->textures->tex_n, 'n');
	load_texture(data, data->textures->tex_e, 'e');
	load_texture(data, data->textures->tex_w, 'w');
	load_texture(data, data->textures->tex_s, 's');
	return (1);
}
